...
@section('title', 'Summer Schedule | Dance Unlimited')
@section('content')
    ...
    <div style="background: white;">
        <div class="container py-5">
            ...
            <h1 class="text-center text-dark"><strong>Summer Schedule</strong></h1>
{{--            <div class="d-flex justify-content-center"><a class="text-white text-center text-decoration-none" target="_blank" href="/images/tuition.png"><div class="btn btn-secondary">Tuition Info</div></a></div>--}}
            ...
            <h3 class="fw-bold text-black">2026 Summer</h3>
            <script type="text/javascript" src="https://app.jackrabbitclass.com/jr3.0/Openings/OpeningsJS?OrgID=551313&Session=2026%Summer&Hidecols=gender,description,openings,session,tuition&style=font-family:Arial"></script>
            <div>
                <h3 class="fw-bold text-black">2026 Summer Camps</h3>
                <script type="text/javascript" src="https://app.jackrabbitclass.com/jr3.0/Openings/OpeningsJS?OrgID=551313&Session=2026%20Summer%20Camps&Hidecols=gender,description,openings,session,tuition&style=font-family:Arial"></script>
            </div>
        </div>
    </div>
    <script>
