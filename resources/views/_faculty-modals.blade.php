<!-- Modal -->
<div class="modal fade" id="cerenaModal" tabindex="-1" aria-labelledby="cerenaModalLabel" aria-hidden="true">
...
<!-- Modal -->
<div class="modal fade" id="emilyModal" tabindex="-1" aria-labelledby="emilyModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border: none; padding: 10px 10px 0 0;">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<!-- Modal -->
<div class="modal fade" id="keynaModal" tabindex="-1" aria-labelledby="keynaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border: none; padding: 10px 10px 0 0;">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<!-- Modal -->
<div class="modal fade" id="lesaModal" tabindex="-1" aria-labelledby="lesaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border: none; padding: 10px 10px 0 0;">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<!-- Modal -->
<div class="modal fade" id="lillianModal" tabindex="-1" aria-labelledby="lillianModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border: none; padding: 10px 10px 0 0;">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<!-- Modal -->
<div class="modal fade" id="makenzieModal" tabindex="-1" aria-labelledby="makenzieModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border: none; padding: 10px 10px 0 0;">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<!-- Modal -->
<div class="modal fade" id="michelleModal" tabindex="-1" aria-labelledby="michelleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border: none; padding: 10px 10px 0 0;">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<!-- Modal -->
<div class="modal fade" id="jessicaModal" tabindex="-1" aria-labelledby="jessicaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border: none; padding: 10px 10px 0 0;">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<!-- Modal -->
<div class="modal fade" id="brookeModal" tabindex="-1" aria-labelledby="brookeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="border: none; padding: 10px 10px 0 0;">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-body text-dark">
                Brooke Gebb is a native of Arkansas and holds a BPA in Dance Performance from Oklahoma City University and a Masters in Educational Leadership from SNU. Prior to beginning her teaching career, she traveled performing on cruise ships, off-Broadway, regional dinner theatres, and theme parks.  She began her teaching career in the public school system, teaching dance at Lake Mary High School in Lake Mary, Florida. She eventually transitioned to PK-5 education and became the Dance Coordinator and Fine Arts Chair at the Pinewood Fine Arts Magnet School in Orlando, Florida where she rewrote and oversaw the dance curriculum for the entire Orange County Public School District. In Oklahoma, she taught PK-5 Visual Art and was selected as the Spring Creek Elementary 2020 Teacher of the Year. Teaching credits also include Dance Masters of America, Lyric Academy, Cotillion NWOKC, New York Film Institute, The Dance Effect, I Love Dance, the University of Oklahoma and numerous dance studios across the country. Brooke is currently an Arts Specialist at the Oklahoma State Dept of Education and works with a federal grant to provide fine arts access to rural Oklahoma schools. Brooke is married to Dr. Paul Gebb, an Associate Professor of Dance and Entertainment and the Director of CETL at OCU, and they have three children.
            </div>
        </div>
    </div>
</div>
