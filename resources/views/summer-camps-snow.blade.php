...
@section('title', 'DU Summer Camps | Dance Unlimited')
@section('content')
    ...
    <div class="container py-5">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 mt-5">
            <div class="col-sm my-3"><img src="/images-snow/camps-0.jpg" alt="summer camp info" class="img-fluid shadow rounded"></div>
            <div class="col-sm my-3"><img src="/images-snow/camps-1.jpg" alt="summer camp info" class="img-fluid shadow rounded"></div>
            <div class="col-sm my-3"><img src="/images-snow/camps-2.jpg" alt="summer camp info" class="img-fluid shadow rounded"></div>
            <div class="col-sm my-3"><img src="/images-snow/camps-3.jpg" alt="summer camp info" class="img-fluid shadow rounded"></div>
        </div>
